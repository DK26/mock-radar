...
#[tokio::test]
pub(crate) async fn post_reference_set_with_sec_token_fields_select_number_of_elements_success() {
    ...
    assert_eq!(response_body, json!({"number_of_elements": 0}));
}
